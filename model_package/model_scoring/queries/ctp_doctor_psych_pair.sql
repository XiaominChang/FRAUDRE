...
/* ============================================
   2) Psychologist contacts (exposure-level)
   ============================================ */
DROP TABLE IF EXISTS psych_claims;
CREATE TEMP TABLE psych_claims AS
(
    SELECT 
        claim_number, 
        claim_exposure_id, 
...
/* ============================================
   3) Doctor-Psych pairs per exposure
   ============================================ */
DROP TABLE IF EXISTS doctor_psych_pairs;
CREATE TEMP TABLE doctor_psych_pairs AS
(
    SELECT DISTINCT
        a.claim_number,
        a.claim_exposure_id,
